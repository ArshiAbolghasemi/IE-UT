...
import com.mizdooni.view.restaurant.ShowAvailableTablesView;
...
public class CommandListener {
    ...
    private void init() {
        this
                ...
                .register("showAvailableTables", ShowAvailableTablesView.class.getName())
                .register("addReview", AddReviewForm.class.getName());
    }
